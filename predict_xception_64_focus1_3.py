...
Xception_model = load_model('/cptjack/totem/yanyiting/Eight_classification/code/xception_64/Xception.hdf5')
...
np.save('prediction_xception_64_list.npy', prediction_list)                    
