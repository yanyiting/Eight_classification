...
NASNetMobile_model = load_model('/cptjack/totem/yanyiting/Eight_classification/code/NASNetMobile_224/NASNetMobile.hdf5')
...
#    patch_img = np.array(patch_img)
        ...
        NASNetMobile_preds = NASNetMobile_model.predict_classes(img)
