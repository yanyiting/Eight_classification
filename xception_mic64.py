...
#model = xception(224)(weights = 'imagenet',include_top = False,input_shape = (224,224,3))
#model.save('xception(224).h5')
base = load_model('xception(64).h5')
...
train_folders = '/cptjack/totem/yanyiting/Eight_classification/data/micro_png_64/train/'
validation_folders = '/cptjack/totem/yanyiting/Eight_classification/data/micro_png_64/val/'
...
callbacks_s = get_callbacks(file_path,top_model,64,patience=5)
