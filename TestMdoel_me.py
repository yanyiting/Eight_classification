...
top_model=load_model('/cptjack/totem/yanyiting/Eight_classification/code/Resnet50_gray224/ResNet50_gray.hdf5')
...
test_folders = '/cptjack/totem/yanyiting/Eight_classification/gray/8_focus/val'
